...
class Artist extends CPHPDatabaseRecordClass
{
	public $fill_query = "SELECT * FROM artist WHERE `id` = '%d'";
	public $verify_query = "SELECT * FROM artist WHERE `id` = '%d'";
	public $table_name = "artist";
	public $id_field = "id";
